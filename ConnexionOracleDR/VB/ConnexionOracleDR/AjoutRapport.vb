Public Class AjoutRapport
    ...
    Private Sub validerRapport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles validerRapport.Click
        ...
        Dim query2 As String = "Insert all into rapport (idRapport,rapport_visite,date_visite,id_visiteur,id_praticien) values(rapport_id.nextval, '" & TextRapport.Text & "',sysdate-100 ,'" & idvisiteur & "','" & idpraticien & "') "
