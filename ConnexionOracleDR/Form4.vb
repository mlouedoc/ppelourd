Public Class Form4
    ...
    Private Sub validerRapport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles validerRapport.Click
        ...
        Dim query2 As String = "Insert all into rapport (idRapport,rapport_visite,date_visite,id_visiteur,id_praticien) values(2, '" & TextRapport.Text & "',sysdate-100 ,'" & idvisiteur & "','" & idpraticien & "') "
        ...
        For Each valeur As [Object] In ListMedicament.Items
            ...
            query2 = query2 & " into quantite (id_rapport,id_medicament,quantite) values (2, '" & tableau(0) & "', '" & tableau(2) & "') "
